...
public class C1_Senkrosizasyon extends TestBase {
    ...
    public void explicit(){
        ...
        WebDriverWait wait= new WebDriverWait(driver, 20);//max 20sn bekleyecek
       ...
       // WebElement itsGoneYazisiElementi=driver.findElement(By.xpath("//p[@id='message']"));
        ...
        // 7. It’s back mesajinin gorundugunu test edin
        WebElement itsBackYazisiElementi=wait.
                until(ExpectedConditions.visibilityOfElementLocated(By.cssSelector("p#message")));
