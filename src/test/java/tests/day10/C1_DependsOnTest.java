...
public class C1_DependsOnTest {
    ...
    public void test01HomePage(){
        ...
        // ● https://www.walmart.com/ adresine gidin.-->bu url si
        //    1. Test : Wallmart ana sayfaya gittiginizi test edin

        driver.get("https://www.walmart.com/");
        String expectedUrl="https://www.walmart.com/";
        String actualUrl= driver.getCurrentUrl();
        Assert.assertEquals(actualUrl,expectedUrl);//isterseniz son kısma virgülden sonra neden olmadığına dair bilgi yazılabilir

    }
    @Test(dependsOnMethods = "test01HomePage")
    public void test02Search(){

        //DEPENDSON OLMADAN VE WEB SAYFASINI GET KOMUTU OLMADAN GİDİYORUZ YANİ ÇALIŞTIRIYORUZ,FAİLED OLDU
        //-test in yanına dependson ve 1. teste gitmesi için 1. methodun ismini string yazdık gitti
        //--beforemethod ve aftermethodlarıda class a çevirdikki çalışırken engel olmasın
        //alttaki testler hangisi olursa olsun onlarıda walmart olan 1.test e bağlamalyımı
        //babda yoksa dedeye gider mantığı yok
